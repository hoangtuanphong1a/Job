...
// Mock job data - in real app, this would come from API based on slug
const jobData = {
  id: "1",
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                {!isApplied ? (
                  <Button
                    ...
                    onClick={() => window.location.href = `/jobs/${params.slug}/apply`}
                  >
          ...
          >
            <div className="p-6">
              ...
              <div className="text-sm text-gray-600 mb-6">
                <strong>{jobData.title}</strong> tại <strong>{jobData.company.name}</strong>
              </div>
